...
var targetSheet = "season4";
var userRowNum = 1;
var userStartColumnNum = 4;
// hogehoge
function getMembers() {
    var activeSpreadSheet = SpreadsheetApp.getActiveSpreadsheet();
    var sheet = activeSpreadSheet.getSheetByName(targetSheet);
    var lastColumn = sheet.getLastColumn();
    var nameRange = sheet.getRange(userRowNum, userStartColumnNum, userRowNum, lastColumn);
    var array = [];
    for (var index = userStartColumnNum; index < lastColumn; index++) {
...
function doGet() {
    ...
    output.setContent(JSON.stringify(getMembers().sort()));
    return output;
}
